...
static void DeterminRobotID()
{
    ...
    // 根据机器人ID计算对应的客户端ID
    switch(referee_recv_info->referee_id.Robot_ID)
    {
        case RobotID_RHero:
            referee_recv_info->referee_id.Cilent_ID = ClientID_RHero;
            break;
        case RobotID_REngineer:
            referee_recv_info->referee_id.Cilent_ID = ClientID_REngineer;
            break;
        case RobotID_RStandard1:
            referee_recv_info->referee_id.Cilent_ID = ClientID_RStandard1;
            break;
        case RobotID_RStandard2:
            referee_recv_info->referee_id.Cilent_ID = ClientID_RStandard2;
            break;
        case RobotID_RStandard3:
            referee_recv_info->referee_id.Cilent_ID = ClientID_RStandard3;
            break;
        case RobotID_RAerial:
            referee_recv_info->referee_id.Cilent_ID = ClientID_RAerial;
            break;
        case RobotID_BHero:
            referee_recv_info->referee_id.Cilent_ID = ClientID_BHero;
            break;
        case RobotID_BEngineer:
            referee_recv_info->referee_id.Cilent_ID = ClientID_BEngineer;
            break;
        case RobotID_BStandard1:
            referee_recv_info->referee_id.Cilent_ID = ClientID_BStandard1;
            break;
        case RobotID_BStandard2:
            referee_recv_info->referee_id.Cilent_ID = ClientID_BStandard2;
            break;
        case RobotID_BStandard3:
            referee_recv_info->referee_id.Cilent_ID = ClientID_BStandard3;
            break;
        case RobotID_BAerial:
            referee_recv_info->referee_id.Cilent_ID = ClientID_BAerial;
            break;
        default:
...
static String_Data_t UI_State_sta[6];
static String_Data_t UI_State_dyn[6];
...
void MyUIInit()
{
    ...
    UICharDraw(&UI_State_dyn[2], "sd2", UI_Graph_ADD, 8, UI_Color_Orange, 15, 2, 270, 650, "LOW      ");
...
static void MyUIRefresh(referee_info_t *referee_recv_info, Referee_Interactive_info_t *_Interactive_data)
{
    ...
    // bullet_speed
    if (_Interactive_data->Referee_Interactive_Flag.bullet_speed_flag == 1)
    {
        ...
        case 15:
            ...
            break;
        case 18:
            UICharDraw(&UI_State_dyn[2], "sd2", UI_Graph_Change, 8, UI_Color_Orange, 15, 2, 270, 650, "MID      ");
            break;
        case 30:
        ...
        UICharRefresh(&referee_recv_info->referee_id, UI_State_dyn[2]);
        _Interactive_data->Referee_Interactive_Flag.bullet_speed_flag = 0;
    }
...
static void UIChangeCheck(Referee_Interactive_info_t *_Interactive_data)
{
    ...
    if (_Interactive_data->bullet_speed != _Interactive_data->last_bullet_speed)
    {
        _Interactive_data->Referee_Interactive_Flag.bullet_speed_flag = 1;
        _Interactive_data->last_bullet_speed = _Interactive_data->bullet_speed;
    }
}